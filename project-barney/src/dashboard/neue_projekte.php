                ...
                <div class="row">
                  ...
                  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                      <form class="form-inline" method="post" action="/php-2019/project-barney/src/dashboard/projekt_erstellen.php">
                        <div class="modal-body">
                          <table>
                            ...
                            <tr>
                              ...
                              <td style="padding-left: 10px"><input class="form-control" type="place" placeholder="Ort" name="veranstaltung_ort" required></td>
                            </tr>
                            <tr>
